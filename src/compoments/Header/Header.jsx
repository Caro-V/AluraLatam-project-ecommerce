      ...
      <div className="container">
        <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          <a href="/" className="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
            <img className="bi me-2" width="60" height="52" role="img" aria-label="Bootstrap" src="public/img/whiteLogo.png" alt="logo blanco" />
          </a>
    ...
    <div className="px-3 py-2 border-bottom mb">
      <div className="container d-flex flex-wrap justify-content-center">
        ...
        <div className="text-end">
          <button type="button" className="btnlogin btn btn-light text-dark me-2">Ingresar</button>
          <button type="button" className="btnsignup btn btn-primary">Registrarse</button>
        </div>
      </div>
    </div>
